          ...
          <div className="col-span-3 border p-4 border-gray-700 rounded-lg">
            ...
            <Tabs defaultValue="balances">
              <TabsList className="justify-around w-full">
                <TabsTrigger className="w-full" value="balances">Balances</TabsTrigger>
                <TabsTrigger className="w-full" value="orders">Orders</TabsTrigger>
                <TabsTrigger className="w-full" value="positions">Positions</TabsTrigger>
                <TabsTrigger className="w-full" value="history">Trade History</TabsTrigger>
              </TabsList>
